...
Route::middleware('auth:sanctum')->group(function () {
  ...
  Route::patch('/posts/{post}', [PostController::class, 'update']); // Update a specific post
  ...
  Route::get('/users/{user}', [UserController::class, 'show']); // Show a specific user's profile
